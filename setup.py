...
setup(
    name='tapioca-linkedin',
    version=get_version(package),
    description='linkedin API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/lerrua/tapioca-linkedin',
    packages=[
        'tapioca_linkedin',
    ],
    package_dir={'tapioca_linkedin': 'tapioca_linkedin'},
